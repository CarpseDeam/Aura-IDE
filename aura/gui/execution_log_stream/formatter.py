"""Pure text normalization helpers for Execution Log prose streams."""
...
# Beat-starter phrases marking a new reasoning segment, used to
...
def normalize_execution_log_text(text: str) -> str:
...
def normalize_assistant_display_text(text: str) -> str:
    """Insert paragraph breaks between adjacent reasoning beat segments.
