"""Qt-backed coalescer for Execution Log prose stream fragments."""
...
class ExecutionLogStreamBuffer(QObject):
    """Batch tiny Execution prose deltas before inserting them into the log view."""
    ...
    def append(self, kind: str, text: str) -> None:
        ...
        normalized = normalize_execution_log_text(text)
        if not normalized:
            return
