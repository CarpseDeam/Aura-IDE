...
TERMINAL_TOOL_DEF: dict[str, Any] = {
    ...
    "function": {
        ...
        "description": (
            ...
            "In Worker mode this tool supports validation/build commands and safe "
            "project-local dependency setup; use read_file/read_files/grep_search/"
            ...
            "for any ecosystem. Safe project-local dependency setup is allowed when needed "
            "for the current coding task, for example 'python -m venv .venv' followed by "
            "a .venv Python pip install, 'uv sync', 'poetry install', or 'pdm install'. "
