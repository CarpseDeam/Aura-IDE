...
class HTMLSyntaxProbe(SyntaxProbe):
    """Syntax probe for HTML files using tree-sitter."""

    language_id: ClassVar[str] = "html"

    @staticmethod
    def detect(file_path: str | Path) -> bool:
        path_str = str(file_path).lower()
        return path_str.endswith(".html") or path_str.endswith(".htm")
    ...
    def check(
        ...
        evidence, line, column, message = _tree_sitter_check(resolved, "html")
...
register_probe(HTMLSyntaxProbe)
