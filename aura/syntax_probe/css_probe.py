...
class CSSSyntaxProbe(SyntaxProbe):
    """Syntax probe for CSS files using tree-sitter."""

    language_id: ClassVar[str] = "css"

    @staticmethod
    def detect(file_path: str | Path) -> bool:
        path_str = str(file_path).lower()
        return path_str.endswith(".css")
    ...
    def check(
        ...
        evidence, line, column, message = _tree_sitter_check(resolved, "css")
