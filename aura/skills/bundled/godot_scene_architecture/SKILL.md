...
path_globs: []
triggers: ["scene tree", "node tree", "ownership", "reparent", "restructure", "dependency injection", "wiring", "autoload", "singleton", "reusable", "scene boundary", "hierarchy", "signal", "group", "resource"]
