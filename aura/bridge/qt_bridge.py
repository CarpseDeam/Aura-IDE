...
WORKER_SYSTEM_PROMPT = (
    ...
    "match of the existing file content. This includes all indentation, whitespace, and blank lines. If an "
    "edit fails due to a mismatch, re-read the file and expand the context block.\n"
