...
- Structural operations such as `create_enclosure`, `attach_room`, `add_upper_level`, `add_upper_wall_section`, `insert_opening`, `add_stair_run`, and `apply_damage` remain semantic because they describe real geometry.
