...
- [Planner/Worker Architecture](planner-worker.md) — Historical two-agent design, retained for backward compatibility only.
- [Drones](drones.md) — Reusable AI workers with write policies, saved per project.
- [Tools Reference](tools.md) — All AI-accessible tools: read, write, git, web, terminal, dispatch.
...
- [Development](development.md) — Architecture, project structure, build & release process.
